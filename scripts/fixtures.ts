...
const EMPLOYEES = [
  'Admin Vivian Srl|admin@kleecks.com',
  'Alessandro Cacciatore|alessandro.cacciatore@kleecks.com',
  'Alessandro Musciola|alessandro.musciola@kleecks.com',
  'Alessia Boeri|alessia.boeri@kleecks.com',
  'Alex Giorgi|alex.giorgi@kleecks.com',
  'Andrea Evangelista|andrea.evangelista@kleecks.com',
  'Andrea Guffi|andrea.guffi@kleecks.com',
  'Anthony Abissino|anthony.abissino@kleecks.com',
  'Aysenaz Darga|darga.aysenaz@kleecks.com',
  'Diana Avelar|diana.avelar@kleecks.com',
  'Digital Operations|digitalop@kleecks.com',
  'Emanuel Oliva ( Ema )|emanuel.oliva@kleecks.com',
  'Emanuela Farina|emanuela.farina@kleecks.com',
  'Gabriele Perchinunno|gabriele.perchinunno@kleecks.com',
  'Giada Birbitello|giada.birbitello@kleecks.com',
  'Gianluca Peretti ( ilgianloo )|gianluca.peretti@kleecks.com',
  'Grazia Pazienza|grazia.pazienza@kleecks.com',
  'Luca Manigrasso|luca.manigrasso@kleecks.com',
  'Lucia Smerilli|lucia.smerilli@kleecks.com',
  'Marco Baricevic ( Bar )|marco.baricevic@kleecks.com',
  'Marco Bezzi|marco.bezzi@kleecks.com',
  'Marco Frassinetti|marco.frassinetti@kleecks.com',
  'Massimo Montanaro|massimo.montanaro@kleecks.com',
  'Matteo Gobbo|matteo.gobbo@kleecks.com',
  'Omar Odino|omar.odino@kleecks.com',
  'Riccardo Di Cecco|riccardo.dicecco@kleecks.com',
  'Roberto Biancucci|roberto.biancucci@kleecks.com',
  'Roberto Pellagatti|roberto.pellagatti_ext@kleecks.com',
  'Sauro Piva|sauro.piva@kleecks.com',
  'Vanessa Noseda|vanessa.noseda@kleecks.com',
].map((s) => {
  const [emp_name, emp_email] = s.split('|');
